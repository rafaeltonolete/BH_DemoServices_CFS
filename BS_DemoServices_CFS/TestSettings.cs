...
namespace CFS_Automation
{
    ...
    public static class UCIAppName
    {
        ...
        public static string FieldResourceHub = "Field Resource Hub";
        public static string WealthManagement = "Wealth Management";
        public static string ConnectedFieldService = "Connected Field Service";
    ...
    public class TestUtility
    {
        ...
        public void ScreenCaptureUCI(object driver, string ssfiletitle)
        {

           
            //++++++TAKING SCREENSHOT
            Screenshot ss = ((ITakesScreenshot)driver).GetScreenshot();
            //You may change the directory to where image will be saved.
            string ssFilePath = "C:\\Users\\USER\\source\\repos\\BH DevOps\\Solutions\\EasyRepro\\BH.DemoServ.INSPC.AO\\TestScreenshot";
            string screenshotfilename = ssfiletitle + ".jpg";

            ss.SaveAsFile(ssFilePath + "\\" + screenshotfilename, ScreenshotImageFormat.Jpeg);
           

        }

        public void InitializeTestRunResultsDir()
        {
